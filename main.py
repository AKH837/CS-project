...
def navigate_to_signup():
    os.system("streamlit run sign-up.py")
...
with st.container():
    ...
    st.markdown("<h3 class='typewriter'>Get access to all your missed lectures from anywhere, anytime.</h3>", unsafe_allow_html=True)
    ...
    with col2:
        signup_button = st.button("Sign-in", use_container_width=True, on_click=navigate_to_signup)
